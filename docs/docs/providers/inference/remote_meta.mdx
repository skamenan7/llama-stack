...
Meta AI inference provider for the OpenAI-compatible api.meta.ai endpoint, with native Chat Completions, Responses, and Messages API support.
...
| `base_url` | `HttpUrl \| None` | No | https://api.meta.ai/v1 | The URL for the Meta AI API server |
