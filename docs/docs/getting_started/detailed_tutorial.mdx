...
description: Build AI applications with Llama Stack using the standard OpenAI SDK
...
This tutorial assumes you've completed the [Quickstart](./quickstart) and have a running Llama Stack server. We'll build progressively more complex applications using the standard OpenAI SDK.
