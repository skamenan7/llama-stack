...
for i, url in enumerate(urls):
    doc_url = f"https://raw.githubusercontent.com/pytorch/torchtune/main/docs/source/tutorials/{url}"
    ...
    file_obj = client.files.create(
        file=(url, content.encode('utf-8'), "text/plain"),
        purpose="assistants",
    )
...
```{dropdown} 👋 Click here to see the sample output
    ...
    inference> [file_search(query='TorchTune')]
    tool_execution> Tool:file_search Args:{'query': 'TorchTune'}
    tool_execution> Tool:file_search Response:[TextContentItem(text='file_search tool found 5 chunks:\nBEGIN of file_search tool results.\n', type='text'), TextContentItem(text='Result 1:\nDocument_id:num-1\nContent:  conversational data, :func:`~torchtune.datasets.chat_dataset` seems to be a good fit. ..., type='text'), TextContentItem(text='END of file_search tool results.\n', type='text')]
