...
**Starter variants**: The `postgres-demo` distribution is the starter pre-configured with PostgreSQL storage ([`ogxai/distribution-postgres-demo`](https://hub.docker.com/r/ogxai/distribution-postgres-demo)).
