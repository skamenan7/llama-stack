...
- **Announcement**: Breaking changes require inclusion in release notes and, if applicable, a separate communication (e.g., Slack or Github Issues) prior to release.
