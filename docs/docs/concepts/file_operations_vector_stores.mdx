...
**Weighted Ranker:**
```python
from ogx_api import SearchRankingOptions
...
```python
from ogx.apis.vector_io import VectorStoreChunkingStrategy
...
[SQLite-vec](../providers/vector_io/inline_sqlite-vec), [pgvector](../providers/vector_io/remote_pgvector), and [Milvus](../providers/vector_io/inline_milvus) support combining vector and keyword search.
