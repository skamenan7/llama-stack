...
| Metric | Value |
|--------|-------|
| **Overall Conformance Score** | 84.7% |
| **Endpoints Implemented** | 28/114 |
| **Total Properties Checked** | 2598 |
| **Schema/Type Issues** | 274 |
| **Missing Properties** | 123 |
| **Total Issues to Fix** | 397 |
...
**Score:** 85.8% · **Issues:** 28 · **Missing:** 4
...
<details>
<summary>Schema Issues (28)</summary>
