...
Llama Stack can act as a proxy server for [Codex CLI](https://github.com/openai/codex), enabling you to use your existing Codex workflows while leveraging Llama Stack's unified provider architecture and conversation compaction features.
