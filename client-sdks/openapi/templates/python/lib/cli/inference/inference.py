...
def chat_completion(ctx, message: str, stream: bool, session: bool, model_id: str | None):
...
def chat_session(client, model_id: str | None, messages: list[dict[str, str]], console: Console):
