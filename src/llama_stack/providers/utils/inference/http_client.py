...
def _network_config_fingerprint(network_config: NetworkConfig) -> str:
...
def _set_client_network_fingerprint(client: httpx.AsyncClient | DefaultAsyncHttpxClient, fingerprint: str) -> None:
...
def _merge_network_config_into_client(
    ...
    fingerprint = _network_config_fingerprint(network_config)
    ...
    try:
        ...
        _set_client_network_fingerprint(new_client, fingerprint)
        ...
        if isinstance(existing_client, DefaultAsyncHttpxClient):
            ...
            _set_client_network_fingerprint(wrapped, fingerprint)
            return wrapped
